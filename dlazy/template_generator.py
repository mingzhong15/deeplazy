...
def _format_modules(modules: List[str]) -> str:
    ...
    lines = [
        ...
        "    # Set up module paths (from /etc/profile.d/modules.sh)",
        '    export MODULEPATH=""',
        "    for x in Applications Compilers Graphics IO_tools Libraries Profiling_tools Environment Tools Proxy; do",
        "        module use --append /thfs4/software/modulefiles/$x 2>/dev/null || true",
        "    done",
